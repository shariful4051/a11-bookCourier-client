                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <div className='flex gap-2'>
                                            <div>
                                                {
                                            order.delivery_status === "pending" && <button onClick={()=>{handleCancel(order)}} className='btn'>Cancel</button>
                                        }
                                            </div>
                                            <div>
                                               {
                                                order.delivery_status !=='Delivered' && <button onClick={()=>handleShiping(order)} className='btn mx-2'>Shiping</button>
                                               }
                                               <button onClick={()=>handleDelivered(order)} className='btn'>Delivered</button> 
